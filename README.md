...
_Краткое описание семестрового проекта:

- Реализуется структура данных под названием "дерево Фенвика" (двоичное индексирвоанное дерево).
...
| :---             |   ---:    |  ---:                 |
| Ахметова Ляйсан  | 33        |  _один за_            |
| Байгулова Эльмира| 33        |  _всех и все_         |
| Насырова Яна     | 33        |  _за одного_          |
